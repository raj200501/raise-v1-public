...
`CORRECTIONS.md`: 19 entries at full size, including a published figure our own reproduction
...
content hashes of every array so the rebuild is *proven* identical, not assumed. 463 mutations across 22 gates certify every gate can fail
