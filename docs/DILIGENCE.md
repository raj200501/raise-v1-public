...
`CORRECTIONS.md`: 15 entries at full size, including a published figure our own reproduction
...
content hashes of every array so the rebuild is *proven* identical, not assumed. 221 mutations across 17 gates certify every gate can fail
