...
`CORRECTIONS.md`: 18 entries at full size, including a published figure our own reproduction
...
content hashes of every array so the rebuild is *proven* identical, not assumed. 400 mutations across 21 gates certify every gate can fail
