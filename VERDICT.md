...
| Result | Value | Class |
|---|---|---|
| Every gate can be shown to fail | 110 mutations, 110 detected, 0 survived | primary-verifiable |
| A number that is real but STALE is caught, not just a fabricated one | `tools/freshness.py`, 9 mutations | primary-verifiable |
| Preregistration chain verifies, reader unchanged since freeze | 8 entries, head `5629a5d4…` | primary-verifiable |
