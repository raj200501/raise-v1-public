...
> **9 of 45 claims are in `neither`.** They can be neither re-derived nor re-run by anyone,
...
| `primary-verifiable` | 29 | A stranger can re-derive it from raw inputs with the shipped code. |
