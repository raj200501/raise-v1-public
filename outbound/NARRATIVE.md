...
> 387 deliberate mutations, 387 detected, 0 survived.
>
...
> Before any measurement, we built the thing that would keep us honest. 17 preregistrations,
...
> 387 deliberate mutations across 21 gates, 387 detected, 0 survived. A gate that cannot fail is decoration, so
...
> included, so the filter itself can be audited. The corrections ledger now carries 16 entries at
...
> 16 corrections at full size, including a published figure our own reproduction contradicted, an
