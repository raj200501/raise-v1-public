...
**14 of 93 claims are in the weakest class** — they can be neither re-derived nor re-run by anyone,
...
python3 tests/mutation_test.py                    # 178 deliberate mutations, 178 detected, 0 survived
