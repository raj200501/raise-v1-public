...
**10 of 60 claims are in the weakest class** — they can be neither re-derived nor re-run by anyone,
...
python3 tests/mutation_test.py                    # 96 deliberate mutations, 96 detected, 0 survived
