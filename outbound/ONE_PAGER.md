...
**13 of 71 claims are in the weakest class** — they can be neither re-derived nor re-run by anyone,
...
python3 tests/mutation_test.py                    # 132 deliberate mutations, 132 detected, 0 survived
