...
**14 of 253 claims are in the weakest class** — they can be neither re-derived nor re-run by anyone,
...
python3 tests/mutation_test.py                    # 555 deliberate mutations, 555 detected, 0 survived
